...
public class C04_WrapperClasses {
    public static void main(String[] args) {
        ...
        /*
        // non-primitive data turlerinin hazir method'lari verken
        ...
        // variable olusturmadan da bazi hazir method'lari kullanabiliriz
        ...
        System.out.println(Character.isLetterOrDigit(krk)); //true
    }
}
