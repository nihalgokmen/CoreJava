...
public class C06_ExplicitNarroving {
    public static void main(String[] args) {
        ...
        System.out.println(in1);  // ondalikli kismi atar sonuc 45

        db1= 3987876765d;  // Java basta buna itiraz eder fakat sayinin sonuna double old belirten d eklersek kabul eder
