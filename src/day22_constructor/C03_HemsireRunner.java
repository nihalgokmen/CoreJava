...
public class C03_HemsireRunner {
    ...
    public static void main(String[] args) {
        ...
        /*
            ...
            olusturulan obje, olusturuldugu classtaki variable'lara atanan degerleri alir
            eger obje olusturulan class'ta deger atamasi yoksa, Java default degerleri atar.
         */
