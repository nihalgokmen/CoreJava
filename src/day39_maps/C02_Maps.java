...
public class C02_Maps {
    ...
    public static void main(String[] args) {
       ...
       Map<Integer, String> okulMap = MapMethodDepo.ornekMapOlustur(); // Klaici olmasi icin yazdirma degil atama yaptik
       ...
       okulMap.put(110, "Kerem-Umut-12-K-MF");
        ...
        MapMethodDepo.subeOgreciListesiYazdir(okulMap, "h");
