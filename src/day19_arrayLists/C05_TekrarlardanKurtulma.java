...
public class C05_TekrarlardanKurtulma {
    ...
    public static void main(String[] args) {
        ...
        // arraydeki her bir elemani ele alalim
        // ele aldigimiz element lsitte yoksa ekleyelim varsa eklemeyelim
        ...
        // istenen listeyi list olarak elde ettik bunu arr'ye direkt atayamayiz
