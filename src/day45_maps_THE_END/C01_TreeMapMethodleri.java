...
public class C01_TreeMapMethodleri {
    ...
    public static void main(String[] args) {
        ...
        // java'da baslangic degerleri inclusive'dir (dahildir), eger tail alirken
        ...
        // java'da bitis degerleri excluding'dir (dahil degildir), eger tail alirken
        // verdigimiz bitis key'inin dahil olmasini istersek, TRUE parametresi yazabiliriz
        ...
        System.out.println(deneme.higherKey("C")); // F ==> C olmasa da olsaydi nerede olurdu bakar
